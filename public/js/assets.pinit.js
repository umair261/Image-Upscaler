!(function (a, b, c, d) {
      ...
      return {
        ...
        loadFont: function (a) {
          e.w.setTimeout(function () {
            e.v.ourStyles.sheet.insertRule(
        ...
        buildStyleSheet: function () {
          var a, b, c, f
          ;(a = e.f.make({ STYLE: { type: 'text/css' } })),
            (b = e.v.css),
        ...
        util: {
          control: function (a) {
            ...
            var d = {
              ...
              pause: a.el.parentNode.getElementsByClassName(
                e.a.k + '_pause'
              )[0],
            }
          ...
          navigate: function (a) {
            ...
            if (f[d].className.match('hazVideo')) {
              ...
              if ((g[0] && g[0].pause(), !d)) {
                var h = a.el.parentNode.getElementsByClassName(
                  e.a.k + '_controls'
                )[0]
                ;(h.style.display = 'none'),
                  (h.getElementsByClassName(e.a.k + '_play')[0].style.display =
                    'block'),
                  (h.getElementsByClassName(e.a.k + '_pause')[0].style.display =
                    'none')
              }
            }
            'forward' === b
              ? (e.f.changeClass(f[d], { past: !0 }), (d += 1))
              : (e.f.changeClass(f[d], { future: !0 }),
                (d -= 1),
                d ||
                  (f[d].className.match('hazVideo') &&
                    e.w.setTimeout(function () {
                      a.el.parentNode.getElementsByClassName(
                        e.a.k + '_controls'
            ...
            for (i = 0; i < j.length; i += 1)
              e.f.changeClass(j[i], { current: i === d })
            if (
              ('forward' === b
                ? (e.f.changeClass(c, { atStart: !1 }),
                  e.f.changeClass(f[d], { future: !1 }),
                  d === f.length - 1 && e.f.changeClass(c, { atEnd: !0 }))
                : (e.f.changeClass(c, { atEnd: !1 }),
                  e.f.changeClass(f[d], { past: !1 }),
                  0 === d && e.f.changeClass(c, { atStart: !0 })),
          ...
          pinOne: function (a) {
            if (a.href) {
              ...
              b.media.match(/^http/i)
                ? (b.description || (b.description = e.d.title),
                  b.description.length > 500 &&
                    (b.description = b.description.substring(0, 500)),
                  e.w.open(
                    a.href,
                    'pin' + new Date().getTime(),
                    e.a.pop.base.replace('%dim%', e.a.pop.size)
                  ))
                : e.f.util.pinAny()
            } else
              a.media
                ? (a.url || (a.url = e.v.here.url),
                  a.description || (a.description = e.d.title),
                  a.description.length > 500 &&
                    (a.description = a.description.substring(0, 500)),
                ...
                : e.f.util.pinAny()
            a.v && a.v.preventDefault
              ? a.v.preventDefault()
              : (e.w.event.returnValue = !1)
          },
              ...
              if ('string' === typeof a[g]) {
                ...
                a.video.mp4 &&
                  ...
                  a.video.m3u8 &&
                    l.appendChild(
                      e.f.make({
                        SOURCE: { src: a.video.m3u8, type: 'video/m3u8' },
                      })
                    ),
                  b.appendChild(l)
              }
            ...
            b &&
              ...
              c &&
                ...
                'function' === typeof e.f.util[e.a.util[c]]
                  ? e.f.util[e.a.util[c]]({ el: b, href: f, v: a })
                  : f && e.w.open(f, '_blank')))
        },
        ...
        showHoverButton: function (a, b) {
          ...
          var c = {
            ...
            lang: e.f.getLang(
              e.f.getData(a, 'lang') || e.v.config.lang || e.v.lang
            ),
          ...
          if (
            ...
            var g = '',
              ...
              i = e.a.k + '_button_pin'
            c.round
              ? ((i = i + ' ' + e.a.k + '_round'), (g = '&round=1'))
              : (i = i + ' ' + e.a.k + '_save'),
              c.tall && ((i = i + ' ' + e.a.k + '_tall'), (g += '&tall=1')),
              (h += g)
            var j,
              k,
              k,
            ...
            c.id
              ? ((h = h + '&id=' + c.id),
                ...
                (k = b
                  ? 'button_pinit_sticky_repin'
                  : 'button_pinit_floating_repin'))
              : ((j =
                ...
                (j =
                  ...
                  '&description=' +
                  encodeURIComponent(
                    e.f.getSelection() || c.description || a.title || e.d.title
                  )),
                (k = b ? 'button_pinit_sticky' : 'button_pinit_floating')),
              (e.s.hoverButton = e.f.make({
                SPAN: { className: i, 'data-pin-log': k, 'data-pin-href': j },
              })),
              ...
              e.v.hazLoggedHoverButton ||
                (b
                  ? e.f.log('&event=impression_sticky' + h)
                  : e.f.log('&event=impression_floating' + h),
                (e.v.hazLoggedHoverButton = !0)),
              (e.s.hoverButton.style.position = 'absolute'),
              (e.s.hoverButton.style.top =
                l.top + e.a.hoverButtonOffsetTop + 'px'),
              (e.s.hoverButton.style.left =
                l.left + e.a.hoverButtonOffsetLeft + 'px'),
        ...
        structure: {
          buttonPin: function (a, b) {
            ...
            var c, d
            return (
              (c = { className: 'button_pin', log: b.log }),
              b.id && (c.id = b.id),
              'button_pinit' === b.log &&
                ((c.tagName = 'A'),
                (c.href =
              ...
              for (g = 0; g < c.pins.length; g += 1) {
                ...
                d.bd.ct[j].col.push({
                  img: {
                    ...
                    backgroundImage: h.images['236x'].url,
                    backgroundColor: h.dominant_color,
                    paddingBottom:
                      (h.images['236x'].height / h.images['236x'].width) * 100 +
                      '%',
                  },
                }),
                  (f[j] = f[j] + h.images['236x'].height)
              }
              return (
                c.board
                  ? ((d.className = d.className + ' board'),
                    (n = e.v.config.pinterest + c.board.url),
                    (d.hd.board = { text: c.board.name, href: n }),
                    ...
                    a.data.section
                      ? ((d.hd.board = {
                          ...
                          href:
                            n +
                            a.theCall.split('/pins/')[0].split('/').pop() +
                            '/',
                        }),
                        (m = 'embed_section_ft'),
                        (e.v.countSection = e.v.countSection + 1))
                      : ((m = 'embed_board_ft'),
                        (d.ft.href = l),
                ...
                '' === p[0] &&
                  ...
                  (r =
                    ...
                    p[1] +
                    '</span>')),
                (d.ft.button.label = { addClass: q, text: r }),
                e.f.buildOne(d)
              )
            }
          },
          embedPin: function (a, b) {
            ...
            if ((b.width || (b.width = 'small'), a.data && a.data[0])) {
                  ...
                  for (var b = a || [], c = 0; c < b.length; c += 1)
                    for (var d = 0; d < b[c].blocks.length; d += 1)
                      if (
                        b[c].blocks[d].type &&
                        b[c].blocks[d].text &&
                        'story_pin_heading_block' === b[c].blocks[d].type
                      )
                ...
                o = function () {
                  var a = {
                      ...
                      image: {
                        ...
                        width: '100%',
                        addClass: 'coverMe',
                        backgroundImage: g.images['236x'].url.replace(
                          /\/236x\//,
                          '/' + imgWidth + '/'
                        ),
                      },
                  ...
                  b &&
                    ...
                    (i.pages = {
                      paddingBottom:
                        ~~(
                          (g.images['236x'].height / g.images['236x'].width) *
                          1e4
                        ) /
                          100 +
                        '%',
                    ...
                    b &&
                      ((i.addClass = i.addClass + ' hazVideo'),
              ...
              if (
                g.story_pin_data &&
                g.story_pin_data.metadata &&
                p[g.story_pin_data.metadata.version]
              ) {
                var q = g.story_pin_data.metadata
                if (
                  (e.f.debug(
                    'Story pin version: ' + q.version + ' ID: ' + g.id
                  ),
                  ...
                  '0' === r[0] &&
                    r[1] &&
                    r[1] - 0 < 10 &&
                    g.story_pin_data.pages.splice(1, 1)
                }
                if (g.story_pin_data.page_count) {
                  var s = {}
                  g.story_pin_data.page_count > 1 &&
                    ((i.pages.overlay.forward_noop = {
                      addClass: 'nav',
                  ...
                  for (c = 0; c < g.story_pin_data.pages.length; c += 1) {
                    if (
                      ((h = g.story_pin_data.pages[c]),
                      (f = { addClass: 'page ' }),
                      (h.style || {}).background_color &&
                        (f.backgroundColor = h.style.background_color),
                      (canHazPage = !1),
                      '0.7.0' === q.version &&
                        h.image_adjusted &&
                        h.image_adjusted.images &&
                        ((canHazPage = !0),
                        (f.blocks = {
                          0: {
                            addClass: 'block',
                            ...
                            image: {
                              ...
                              width: '100%',
                              backgroundImage:
                                h.image_adjusted.images.originals.url.replace(
                                  /\/originals\//,
                                  '/' + imgWidth + '/'
                                ),
                              backgroundColor:
                                h.image_adjusted.dominant_color || '#888',
                            },
                          },
                        }),
                        ...
                        if (w) {
                          ...
                          if ('story_pin_heading_block' === v.type) {
                            ...
                            x.alignment && 1 === x.alignment && (B = 'center'),
                              x.vertical_alignment &&
                                (1 === x.vertical_alignment && (A = 'middle'),
                          ...
                          if (
                            ('story_pin_image_block' === v.type &&
                              ...
                              (y.image = {
                                ...
                                width: '100%',
                                backgroundImage:
                                  v.image.images.originals.url.replace(
                                    /\/originals\//,
                                    '/' + imgWidth + '/'
                                  ),
                                backgroundColor:
                                  v.image.dominant_color || '#888',
                              }),
                              '100' !== w.height &&
                                (y.image.addClass = 'coverMe')),
                            'story_pin_video_block' === v.type &&
                              ((v.video || {}).video_list || {}).V_720P &&
                              ((v.video || {}).video_list || {}).V_HLSV4)
                          ) {
                            var C = v.video.video_list.V_720P,
                              D = v.video.video_list.V_HLSV4,
                              E =
                                v.video.video_list.V_720P.thumbnail ||
                                v.video.video_list.V_HLSV4.thumbnail
                            C.url &&
                              D.url &&
                              ((y.container = {
                                addClass: 'video',
              ...
              if (g.native_creator) {
                var H = (g.description || '')
                  ...
                  .trim()
                ;(G =
                  ((g.story_pin_data || {}).metadata || {}).pin_title ||
                  n((g.story_pin_data || {}).pages) ||
                  (g.rich_metadata || {}).title ||
                  H ||
                  (g.native_creator || {}).about),
                ...
                g.rich_metadata
                  ? (g.rich_metadata.products &&
                      'object' === typeof g.rich_metadata.products[0] &&
                      g.rich_metadata.products[0].offer_summary &&
                      g.rich_metadata.products[0].offer_summary.price &&
                      (i.pages.overlay.price = {
                    ...
                    (g.attribution || {}).author_name &&
                      (F.credit = e.a.strings[b.lang].by.replace(
                        /%s/,
                        g.attribution.author_name
                      )))
                  : (F = {
              ...
              ;(i.footer = {
                ...
                container: {
                  ...
                  deets: {
                    topline: { text: F.credit },
                    bottomline: { text: F.name },
                  },
                },
              }),
                i.footer.container.deets.bottomline.text
                  ? F['native'] && (i.footer.addClass = 'native')
                  : (i.footer.addClass = 'uno')
              var I = e.f.buildOne(i)
              return (
                e.f.changeClass(I, { fresh: !0 }),
        ...
        getLegacy: {
          ...
          buttonPin: function (a, b) {
            ...
            c.zero && (b.zero = !0),
              ...
              c.tall && ((b.tall = !0), 'false' === c.tall && (b.tall = !1)),
              c.round && ((b.round = !0), 'false' === c.round && (b.round = !1))
          },
        },
        seek: {
          ...
          embedBoard: function (a, b, c) {
            ...
            ;(f = e.f.getPath(b)),
              ...
              f.length > 1 &&
                ...
                2 === f.length && ((g = f[0] + '/' + f[1]), (d = 'board')),
                3 === f.length &&
                  f[2] &&
                  ((g = f[0] + '/' + f[1] + '/' + f[2]), (d = 'section')),
                c && (d = 'board'),
                ...
                'https:' === e.w.location.protocol &&
                  (i = '&base_scheme=https'),
                e.f.call(
                  e.a.endpoint[d].replace(/%s/, g) + '?sub=' + e.v.sub + i,
                  function (c) {
                    'success' === c.status &&
                      ('board' === d &&
                        e.f.replace(a, e.f.structure.embedGrid(c, h)),
                      'section' === d &&
                        (c.data.pins.length
                          ? e.f.replace(a, e.f.structure.embedGrid(c, h))
                          : e.f.seek.embedBoard(a, b, !0))),
                      'failure' === c.status &&
                        'section' === d &&
                        e.f.seek.embedBoard(a, b, !0)
                  }
            ...
            ;(c = e.f.getPath(b)),
              c.length &&
                ...
                'https:' === e.w.location.protocol &&
                  (f = '&base_scheme=https'),
                e.f.call(
                  e.a.endpoint.user.replace(/%s/, c[0]) + '?sub=' + e.v.sub + f,
                  function (b) {
          ...
          embedPin: function (a) {
            ...
            ;(b = e.f.getPath(a.href)),
              b.length &&
                ...
                'true' === c.internal &&
                  (c.endpoint = 'https://api.pinadmin.com/internal/pins/info/'),
                (d = ''),
                'https:' === e.w.location.protocol &&
                  (d = '&base_scheme=https'),
                e.f.call(
                  c.endpoint + '?pin_ids=' + b[1] + '&sub=' + e.v.sub + d,
                  function (b) {
        ...
        getLang: function (a) {
          ...
          return (
            ...
            b.length &&
              ...
              ((d = b[0]),
              b.length &&
                ((c = d + '-' + b[b.length - 1]), e.a.strings[c] && (d = c))),
            d
          )
        },
        canHazButton: function (a) {
          ...
          return (
            a &&
              a.tagName &&
              'IMG' === a.tagName &&
              ((b = e.f.getData(a, 'media') || a.src),
              b &&
                b.match(/^https?:\/\//) &&
                (e.f.getData(a, 'no-hover') ||
                  e.f.getData(a, 'nohover') ||
                  e.f.getData(a, 'nopin') ||
                  e.f.get(a, 'data-nopin') ||
                  (c = !0))),
            c
          )
        },
        sticky: {
          find: function (a) {
            ...
            return (
              ...
              e.f.canHazButton(b) &&
                (c = { rect: b.getBoundingClientRect(), img: b }),
              c
            )
          },
          hide: function () {
              ...
              for (b = 0; b < e.w.innerWidth; b += e.w.innerWidth / 10)
                (c = e.f.sticky.find({
                  ...
                  c.rect &&
                    c.img &&
                    !h[c.img.src] &&
                    ((h[c.img.src] = !0), i.push({ img: c.img, rect: c.rect }))
          ...
          observe: function () {
            e.v.sticky.hazChange
              ? e.w.pageYOffset === e.v.sticky.pageY
                ? (e.f.sticky.fire(), (e.v.sticky.hazChange = !1))
        ...
        getHere: function () {
          var a,
            b = e.d.getElementsByTagName('LINK'),
            c = '',
          ...
          for (a = 0; a < d.length; a += 1)
            (value = d[a].getAttribute('content')),
              value &&
                ((key = d[a].getAttribute('name')),
                key &&
                  (f || 'pin:url' !== key.toLowerCase() || (f = value),
                  g || 'og:url' !== key.toLowerCase() || (g = value)))
          for (a = 0; a < b.length; a += 1)
            if (
              b[a].rel &&
              'canonical' === b[a].rel.toLowerCase() &&
              b[a].href
            ) {
              c = b[a].href
              break
        ...
        init: function () {
          ...
          null !== e.v.userAgent.match(/MSIE/) &&
            ...
            e.v.userAgent.match(/MSIE [5-8]/) &&
              ((b = !0),
              e.f.log(
                '&event=oldie_error&ua=' + encodeURIComponent(e.v.userAgent)
              ))),
            b ||
              (e.f.config(),
              ...
              e.v.config.hover &&
                ('false' !== e.v.config.hover
                  ? (e.f.debug('hover: allowed per config'),
                    (e.v.canHazHoverButtons = !0),
                    (e.v.countButton = e.v.countButton + 1),
                    e.d.b.setAttribute('data-pin-hover', !0),
                    e.f.listen(e.d.b, 'mouseover', e.f.over),
                    'false' !== e.v.config.sticky
                      ? (e.f.debug('sticky: allowed per config'),
                        e.v.hazMobile
                          ? (e.f.debug('sticky: initing'), e.f.sticky.init())
                          : e.f.debug('sticky: ontouchstart not found'))
                      : e.f.debug('sticky: forbidden by config'))
                  : e.f.debug('hover: forbidden by config')),
              e.f.exposeUtil(),
              e.f.listen(e.w, 'blur', function (a) {
                for (
                  var b = e.d.getElementsByTagName('VIDEO'), c = 0;
                  c < b.length;
                  c += 1
                )
                  if (b[c].className === e.a.k + '_video') {
                    b[c].pause()
                    for (
                      var d = e.d.getElementsByClassName(e.a.k + '_pause'),
                        f = 0;
                      f < d.length;
                      f += 1
                    )
                    ...
                    for (
                      var g = e.d.getElementsByClassName(e.a.k + '_play'),
                        f = 0;
                      f < g.length;
                      f += 1
                    )
  ...
  me: /pinit\.js$/,
  myDomain:
    /^https?:\/\/(([a-z]{1,3})\.)?pinterest\.([a-z]{0,2}\.)?([a-z]{1,3})/,
    ...
    'span._embed_pin': {
      ...
      '._pages': {
        ...
        '._overlay': {
          ...
          '._repin': {
            ...
            color: '#fff',
            background:
              '%saveButtonBackgroundColor% url(%logo%) 10px 50% no-repeat',
      ...
      '&._medium': {
        ...
        '._pages': {
          ...
          '._overlay': {
            '._progress': { '._indicator': { margin: '16px 4px 0' } },
          },
        },
      },
      '&._large': {
      ...
      '&._atStart': {
        '._pages': { '._overlay': { '._backward': { display: 'none' } } },
      },
      '&._atEnd': {
        '._pages': { '._overlay': { '._forward': { display: 'none' } } },
      },
    },
    '._button_follow': {
      display: 'inline-block',
